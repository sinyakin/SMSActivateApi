package com.sms_activate.respone.rent.set_rent_status;

import org.jetbrains.annotations.NotNull;

public enum SMSActivateSetRentStatusRequest {
   ...
   */
  SMSActivateSetRentStatusRequest(int id, @NotNull String russianMessage, @NotNull String englishMessage) {
    this.id = id;
